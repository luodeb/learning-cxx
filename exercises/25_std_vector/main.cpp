...
int main(int argc, char **argv) {
    {
        ...
        // The size of vector itself (not its contents) is typically 24 bytes on most systems
        // It contains pointers and size information
    ...
    {
        std::vector<char> vec(48, 'z'); // Size 48, all initialized to 'z'
